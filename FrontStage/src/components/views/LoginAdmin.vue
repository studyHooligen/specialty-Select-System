<template>
  <div class="register">
    <div>
      ...
      />
      <div>
        <div class='user-router' :style="{width: loginWindow.width,right: loginWindow.right, top: loginWindow.top, left: loginWindow.left, borderRadius: loginWindow.borderRadius}">
          <div class='user-login-form' :style="{width: loginWindow.width , borderRadius: loginWindow.borderRadius, padding: loginWindow.padding}">
            <div class='user-login-change-bar'>
              <div class='user-login-text'>管理员登录</div>
            </div>
      ...
      jQuery.post(
        ...
        function (res) {
          if(res.code == '1'){
            ...
            that.$cookies.set('adminAccount', that.loginForm.account)
            that.$cookies.set('adminPassword', that.loginForm.password)
            that.redirect('RegisterForm')
          }
          else{
            that.$message({
              message: res.msg,
